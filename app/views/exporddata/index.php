                ...
                <div class="col-md-12 row">
                      ...
                      <!-- <div class="row col-md-4">
                        ...
                        <form role="form" action="<?= base_url; ?>/exporddata/cetakpdfdetail" target="_blank" method="POST" enctype="multipart/form-data">
                            <input type="hidden" class="form-control col-md-6" id="tahun_pdf" name="tahun" value ="2024">
                            <input type="hidden" class="form-control col-md-6" id="bulan_pdf" name="bulan" value ="2">
                          <button type="submit" class="btn btn-primary">PDF2</button>
                          </form>
                      </div>
                        </div>
                      <div class="col-md-4">
...
function  gettanggal(){
  ...
  function setTanggalAwalAkhir(tahun,bulan){
   ...
   $.ajax({
	   ...
	   //tabale full 
   $(document).on("change","#fulltabel",function(e){
    e.preventDefault();
      ...
      if(st_tabel=="Y"){
		Tampildatafullabsensi(datas,st_tabel)
      }else{
		Tampildatafullabsensi(datas,st_tabel)
		//Tampildataabsensisajah(datas)
	  }	
...
//untuk tampil full tabel  by wardi 29/04/24
   function Tampildatafullabsensi(datas,st_tabel){
    $.ajax({
...
function settabelfull(result,st_tabel){
            ...
            let  id =``;
                ...
                <div class="row col-md-4">
					...
					if(st_tabel =="Y"){
						...
						dataTable +=`  <form role="form" action="<?= base_url; ?>/exporddata/cetakpdf" target="_blank" method="POST" enctype="multipart/form-data">
                            <input type="hidden" class="form-control col-md-6" id="tahun_pdf" name="tahun" value ="${tahun}">
                            <input type="hidden" class="form-control col-md-6" id="bulan_pdf" name="bulan" value ="${bulan}">
						        ...
						        dataTable +=`
                                    ...
                                    <table id="${tb_nama}" class="display table-info" style='width:100%'>                    
                                                    ...
                                                    <tr>
                                                                ...
                                                                <th  width="150px" class="text-end">Salery</th>
                                                                ...
                                                                <th  width="150px" class="text-end">Gapok</th>
                                                                <th  width="150px" class="text-end">Gaji Lembur</th>
                                                                <th  width="150px" class="text-end">Gaji Diterima</th>
							 ...
							 $.each(data_tabel,function(a,b){
										...
										dataTable +=`
											  <tr>
												...
												<td width="150px" class="text-end">${b.saleri}</td>
												...
												<td width="150px" class="text-end">${b.gapok}</td>
												<td width="150px" class="text-end">${b.gaji_lembur}</td>
												<td width="150px" class="text-end">${b.gaji_diterima}</td>
										   `
												dataTable+=`</tr>`;
										});
                  dataTable+=`</tbody>
					 ...
					 $("#fulltabel").val(st_tabel);
					  let str_id = id.slice(0,-1);

            if(st_tabel=="Y"){
					     datatabelfullAbsens(str_id)
            }else{
              datatabelTidakfullAbsens(str_id)
            }
                  ...
                  "footerCallback": function ( row, data, start, end, display ) {
                       ...
                       // Total and
                         ...
                         totalgapok = api
                              ...
                              .reduce((a, b) =>intVal(a) + intVal(b), 0);
                       // Total and
                         // Total totalgajilembur
                             totalgajilembur = api
                              .column(9)
                              .data()
                              .reduce((a, b) =>intVal(a) + intVal(b), 0);
                       // Total and
                      // Total totalgajiterima
                      totalgajiterima = api
                              .column(10)
                              .data()
                              .reduce((a, b) =>intVal(a) + intVal(b), 0);
                       // Total and
                          ...
                          total_salery.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
                           
                          
                          api.column(8).footer().innerHTML =
                          totalgapok.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")

                          api.column(9).footer().innerHTML =
                          totalgajilembur.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")

                          api.column(10).footer().innerHTML =
                          totalgajiterima.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")
    ...
    function datatabelTidakfullAbsens(str_id){
      let data_id = str_id.split(",");
